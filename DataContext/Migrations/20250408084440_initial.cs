    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Europe", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(8058), new TimeSpan(0, 0, 0, 0, 0)), null, null },
                    { 2, "Asia", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(8659), new TimeSpan(0, 0, 0, 0, 0)), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Bulgaria", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(8902), new TimeSpan(0, 0, 0, 0, 0)), null, null },
                    { 2, 1, "Romania", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(9130), new TimeSpan(0, 0, 0, 0, 0)), null, null },
                    { 3, 1, "Serbia", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(9132), new TimeSpan(0, 0, 0, 0, 0)), null, null },
                    { 4, 2, "China", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(9134), new TimeSpan(0, 0, 0, 0, 0)), null, null },
                    { 5, 2, "Japan", new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 221, DateTimeKind.Unspecified).AddTicks(9136), new TimeSpan(0, 0, 0, 0, 0)), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, 1, new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 222, DateTimeKind.Unspecified).AddTicks(73), new TimeSpan(0, 0, 0, 0, 0)), null, "Sofia International Airport EAD", null },
                    { 2, null, 2, new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 222, DateTimeKind.Unspecified).AddTicks(80), new TimeSpan(0, 0, 0, 0, 0)), null, "Bucharest International Airport EAD", null },
                    { 3, null, 3, new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 222, DateTimeKind.Unspecified).AddTicks(82), new TimeSpan(0, 0, 0, 0, 0)), null, "Belgrad Henri Coandă Airport", null },
                    { 4, null, 4, new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 222, DateTimeKind.Unspecified).AddTicks(84), new TimeSpan(0, 0, 0, 0, 0)), null, "Beijing Capital International Airport", null },
                    { 5, null, 5, new DateTimeOffset(new DateTime(2025, 4, 8, 8, 44, 40, 222, DateTimeKind.Unspecified).AddTicks(86), new TimeSpan(0, 0, 0, 0, 0)), null, "Tokyo Airport", null }
                });
